        ...
        grecaptcha.ready(function() {
            grecaptcha.execute('6Leds4MsAAAAAHVwNKZjwf63BauT5kJWX9_MYvup', {action: 'submit_lead'})
                .then(function(token) {
                   ...
                   /*  $.ajax({
                        url: _self.attr("action"),          // ← берём из action="submit.php"
                        type: "POST",
                        dataType: "json",
                        data: data,
                        success: function (response) {
                            // твоя текущая логика показа сообщений
                            $form.trigger("reset");
                        ...
                        error: function() {
                            $("#message").html("<p class='color-primary mt-16 mb-16'>Server error</p>").show();
                            $form.find('button[type="submit"]').prop("disabled", false);
                        }
                    }); */
                })
